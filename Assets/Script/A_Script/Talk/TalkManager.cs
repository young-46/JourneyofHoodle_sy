...
public class TalkManager : MonoBehaviour
{
    ...
    void Awake()
    {
      ...
      // nickname = StageManager.GetComponent<TransData>().nickname;
        ...
        {
            if(GameObject.Find("SaveManager").GetComponent<ColorChange>().icekind == "Mint"){
                a = 6;
            }
            else
            {
    ...
    void GenerateData()
    {
        ...
        "으아악! 내 몸을 돌려내!!:" + a, icenickname + "아(야)! 정신 차려야 돼! 우리 행성을 구해야지!:6", "구하긴 뭘 구해! 이미 너희 행성은 끝났다고! 정신을 차린다고 구할 수 있을 거 같아?:0"});
